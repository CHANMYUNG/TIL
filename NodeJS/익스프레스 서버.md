...
**익스프레스에서 미들웨어를 사용하는 방식**  
![MiddleWare](./express_resources/middleWare.png)
...
![files](./express_resources/middleWare_Static.png)  
...
![directory](./express_resources/body_parser_directory.png)  
...
2. 예제(쿠키를 함께 사용함)  
**디렉토리 구조**  
![express_directory](./express_resources/session_directory.png)  
...
2. 예제  
**디렉토리 구조**  
![multer_directory](./express_resources/session_directory.png)  
